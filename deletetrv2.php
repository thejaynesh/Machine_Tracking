...
<body>
   ...
   <center><h1>CONFIRM DELETE</h1></center>
    ...
    <form method="post" action=<?= 'deletetrv2.php?tr_id=' . $_GET['tr_id'] ?> class="register-form">
    <p>Are you sure ?</p>
    <input type="hidden" name="id"
    value="<?php echo $_GET['tr_id']?>"
    />
    <div class="form-submit">
        
        <input type="submit" value="Delete" name="delete" id="Submit" class="Submit">
        <input type="reset" value="Reset" class="submit" id="reset" name="reset" />
            </div>
    <input type="hidden" name="id" value="<?php echo $_GET['tr_id']?>">
    </p>
    </form>
