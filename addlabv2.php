...
<div class="form-group">
        ...
        <input type="text" name="lab_name" required class="form-control" placeholder="Lab Name/Number" id="lb" onchange="labs('lb')"> </div>

        <div class="form-input">
        <label>Department </label>
        <input type="text" name="department" required class="form-control" placeholder="Department Name" id="depname" onchange="Names('depname')"> </div>

        <div class="form-submit">
        
        <input type="submit" value="Add Lab" name="add" id="Submit" class="Submit">
