<?php
    ...
    if(isset($_POST['remarks']) )
    {
        if ( strlen($_POST['remarks']) < 1)
        {
            ...
            header('Location: mcrepairedv2.php');
            return;
        }
        else
        {
...
<body>
   ...
   <center><h1>MACHINE FIXED</h1></center>
    ...
    <form method="POST" action="mcrepairedv2.php" class="register-form">
    <div class="form-row">
    <div class="form-group">
    <div class="form-input">
    <label>Remarks</label>
    <input type="text" name="remarks" required class="form-control"> </div>
    
    <div class="form-submit">
        
        <input type="submit" value="Machine Repaired" name="add" id="Submit" class="Submit">
