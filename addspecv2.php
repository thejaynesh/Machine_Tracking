...
<body>
   ...
   <center><h1>ADD SPECIFICATION</h1></center>
        ...
        <form method="POST" action="addspecv2.php">
    ...
    <div class="form-input">
        ...
        <input type="text" name="spec" required class="form-control" placeholder="Specification of Hardware"> </div>
