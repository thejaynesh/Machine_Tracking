<?php
    ...
    if(isset($_POST['lab_name']) )
    {
        if ( strlen($_POST['lab_name']) < 1 )
        {
            ...
            header('Location: deletelabv2.php');
            return;
        }
        else
        {
...
?></a>
   ...
   <center><h1>DELETE LAB</h1></center>
    ...
    <form method="POST" action="deletelabv2.php" class="register-form">
    <div class="form-row">
    <div class="form-group">
    <div class="form-input">
    <label>Lab Name </label>
    <input type="text" name="lab_name" required="" class="form-control" placeholder="Lab Name/Number" id="lab" onchange="labs('lab')"> </div>
