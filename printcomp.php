...
<body style="margin-left: 100px; margin-right: 100px; margin-top: 100px">
    ...
    <div class="container">
        <span class="col-xs-10">
            ...
            <?php
            $midq=$_GET['mc_id'];
            $stmtn3 = $pdo->prepare("SELECT complaint_book_id FROM complaint_book where machine_id = :mid AND completed IS NULL");
        ...
        <span>
            ...
            <?php
            $midq=$_GET['mc_id'];
            $stmtn6 = $pdo->prepare("SELECT Date_of_complaint FROM complaint_book where machine_id = :mid AND completed IS NULL");
    ...
    <div class="container">
        ...
        <span class="col-xs-4">
            ...
            $midq=$_GET['mc_id'];
            $stmtn6 = $pdo->prepare("SELECT complaint_by FROM complaint_book where machine_id = :mid AND completed IS NULL");
                $stmtn6->execute(array(':mid' => $midq));
                $rown6 = $stmtn6->fetch(PDO::FETCH_ASSOC);
    ...
    <?php
        ...
        if($row['COUNT(*)']!=='0')
        {
            ...
            echo ("<table class=\"table table-striped\">
                ...
                $stmtn2->execute(array(':mid' => $_GET['wf']));
                ...
                $stmtn6 = $pdo->prepare("SELECT Date_of_complaint FROM complaint_book where complaint_book_id = :cid ");
                $stmtn6->execute(array(':cid' => $rown3['complaint_book_id']));
                $rown6 = $stmtn6->fetch(PDO::FETCH_ASSOC);
