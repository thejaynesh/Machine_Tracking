...
<body>
   ...
   <center><h1>ADD NEW MEMBER</h1></center>
    ...
    <label>ID</label> 
    <input type="text" name="id" required="" class="form-control" placeholder="Enter Collge ID" id="Mid" onchange="labs('Mid')"> </div>

    <div class="form-input">
    <label>First Name</label>
    <input type="text" name="first_name" required="" class="form-control" id="fname" onchange="Names('fname')" placeholder="First Name"> </div>

    <div class="form-input">
    <label>Last Name</label>
    <input type="text" name="last_name" required="" class="form-control" id="lname" onchange="Names('lname')" placeholder="Surname"> </div>

    <div class="form-input">
    <label>Email</label>
    <input type="email" name="email" required="" class="form-control" placeholder="xyz@abc.com"> </div>

    <div class="form-input">
      <label>Contact No.</label>
      <input type="text" name="contact_no" class="form-control" required placeholder="10 digit number" id="cnct" onchange="contact('cnct')"> </div>

    <div class="form-input">
    <label>Password</label>
    <input type="password" name="pass" required="" class="form-control" placeholder="min. 8 characters" id="npswrd" onchange="newp('npswrd')"> </div>
    ...
    <div class="form-submit">
        ...
        <input type="submit" value="Add Member" name="add" id="Submit" class="Submit">
