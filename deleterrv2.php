...
<body>
   ...
   <center><h1>CONFIRM DELETE</h1></center>
    <?php
    ...
    <form method="post" action=<?= 'deleterrv2.php?cb_id=' . $_GET['cb_id'] ?> class="register-form">
    <p>Are you sure ?</p>
    <input type="hidden" name="id"
    value="<?php echo $_GET['cb_id']?>"
    />
    <div class="form-submit">
        
        <input type="submit" value="Delete Request" name="add" id="Submit" class="Submit">
    </div>
    <input type="hidden" name="id" value="<?php echo $_GET['cb_id'] ?>">
    </p>
    </form>
